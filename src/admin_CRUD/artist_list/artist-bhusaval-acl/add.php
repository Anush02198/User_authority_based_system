...
echo "$target";
  	 $sql = "INSERT INTO artist_list (name, bio, image, uploaded_by,division)VALUES ('$name','$bio','$image','admin_bsl-acl','bhusaval-acl');";
     mysqli_query($db, $sql);
                }
?>
<html>
...
<div class="upload">
   <h1>UPLOAD IMAGE:</h1>
    <form method="POST" action="artist_list-bsl-acl.php" enctype="multipart/form-data">
