 ...
 <?php
  ...
  if (isset($_POST['upload'])) {
  	...
  	$target = "../images/".basename($image);
  	 $sql = "INSERT INTO artist_list (name, bio, image, uploaded_by,division)VALUES ('$name','$bio','$image','admin_pr','parel');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM artist_list where uploaded_by = 'admin_pr'");
?>
<!DOCTYPE html>
<html>
<head>
