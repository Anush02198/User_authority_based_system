...
echo "$target";
  	$sql = "INSERT INTO artist_list (name, bio, image, uploaded_by)VALUES ('$name','$bio','$image','admin_sul');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM artist_list where uploaded_by = 'admin_sul'");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="upload">
   <h1>UPLOAD IMAGE:</h1>
    <form method="POST" action="artist_list-solapur.php" enctype="multipart/form-data">
