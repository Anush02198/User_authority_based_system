...
if($role == 'sadmin'){
  $result = mysqli_query($db, "SELECT * FROM artist_list WHERE uploaded_by IN ('sadmin', 'admin_pr')");    
}else{
...
<div class="upload">
   <h1>UPLOAD IMAGE:</h1>
    <form method="POST" action="artist_list-parel.php" enctype="multipart/form-data">
