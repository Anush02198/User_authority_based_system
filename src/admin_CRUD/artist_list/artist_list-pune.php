...
echo "$target";
  	$sql = "INSERT INTO artist_list (name, bio, image, uploaded_by)VALUES ('$name','$bio','$image','admin_pun');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM artist_list where uploaded_by = 'admin_pun'");
?>
