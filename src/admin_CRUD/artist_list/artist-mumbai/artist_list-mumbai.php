 ...
 <?php
  ...
  if (isset($_POST['upload'])) {
  	...
  	$target = "../images/".basename($image);
  	 $sql = "INSERT INTO artist_list (name, bio, image, uploaded_by,division)VALUES ('$name','$bio','$image','admin_mum','mumbai');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM artist_list where uploaded_by = 'admin_mum'");
?>
<!DOCTYPE html>
<html>
<head>
...
<a href="../../../admin/logout.php" class="btn btn-danger" role="button" style="float : right; margin-left : 20px;">Logout  <i class="fa fa-arrow-right"></i></a>
   <a href="add.php" class="btn btn-success" role="button" style=" float : right;"><i class="fa fa-plus"></i> Add Artist</a>
    </div>
    <table class="table table-striped">
		<thead>
			 <tr>
				<th scope="col" width="20%"> name </th>
				<th scope="col" width="50%"> bio </th>
