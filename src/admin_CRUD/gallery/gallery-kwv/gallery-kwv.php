 ...
 <?php
  ...
  if (isset($_POST['upload'])) {
  	...
  	$target = "../images/".basename($image);
  	 $sql = "INSERT INTO `images` (images, uploaded_by,division)VALUES ('$image','admin_kwv','kurudwadi');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM `images` where uploaded_by = 'admin_kwv'");
?>
<!DOCTYPE html>
<html>
<head>
