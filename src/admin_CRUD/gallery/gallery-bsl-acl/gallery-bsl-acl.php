 ...
 <?php
  ...
  if (isset($_POST['upload'])) {
  	...
  	$target = "../images/".basename($image);
  	 $sql = "INSERT INTO `images` (images, uploaded_by,division)VALUES ('$image','admin_bsl-acl','bhusaval-acl');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM `images` where uploaded_by = 'admin_bsl-acl'");
?>
<!DOCTYPE html>
<html>
<head>
