...
echo "$target";
  	 $sql = "INSERT INTO `images` (image, uploaded_by,division)VALUES ('$image','admin_mum','$division');";
     mysqli_query($db, $sql);
                }
?>
<html>
...
<div class="upload">
   <h1>UPLOAD IMAGE:</h1>
    <form method="POST" action="gallery-mumbai.php" enctype="multipart/form-data">
