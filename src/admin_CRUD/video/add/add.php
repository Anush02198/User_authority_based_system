...
<?php
	if (isset($_POST['submit'])) {
		require_once("db.php");
		$sql = $conn->prepare("INSERT INTO awards_achievements (year,achievements,uploaded_by) VALUES (?,?,?)");  
		$year=$_POST['year'];
		$role = 'admin_ngp';
		$achievements = $_POST['achievements'];
		$sql->bind_param("sss", $year,$achievements, $role); 
		if($sql->execute()) {
...
<div class="button_link"><a href="../achievements/achievement_nagpur.php"> Back to List </a></div>
