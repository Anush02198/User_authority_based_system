...
$sql = "SELECT * FROM awards_achievements WHERE uploaded_by='admin_mum'";
...
<body>
    <div><center><img src="http://10.31.3.3/Nimg/ITHeader2.png" style="vertical-align: top;"></center></div>
...
<a href="add/add_mum.php" class="btn btn-success" role="button" style="float : right;"><i class="fa fa-plus"></i> Add An Achievement</a>
</div>
