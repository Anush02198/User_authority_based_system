...
$sql = "SELECT * FROM awards_achievements WHERE uploaded_by='admin_by'";
...
<a href="../../admin/logout.php">Logout</a>
	...
	<div class="button_link"><a href="add/add_by.php">Add New</a></div>
    <table class="table table-striped">
		...
		<tbody>		
			...
			<tr class="table-row" id="row-<?php echo $row["id"]; ?>"> 
				...
				<!-- action -->
				<td class="table-row" colspan="2"><a href="edit/edit_by.php?id=<?php echo $row["id"]; ?>" class="link"><img title="Edit" src="icon/edit.png"/></a> <a href="delete/delete_by.php?id=<?php echo $row["id"]; ?>" class="link"><img name="delete" id="delete" title="Delete" onclick="return confirm('Are you sure you want to delete?')" src="icon/delete.png"/></a></td>
			</tr>
			<?php
					}
				}
