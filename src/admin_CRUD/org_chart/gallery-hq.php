 ...
 <?php
  ...
  if (isset($_POST['upload'])) {
  	...
  	$target = "../images/".basename($image);
  	 $sql = "INSERT INTO `org_chart` (org_chart)VALUES ('$image');";
     mysqli_query($db, $sql);
                }

  $result = mysqli_query($db, "SELECT * FROM `org_chart`;");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <table class="table table-striped">
		...
		<tbody>		
			...
			<tr class="table-row" id="row-<?php echo $row["id"]; ?>"> 
				<td class="table-row"><?php echo "<img src='images/".$row['org_chart']."'width='250px;' height='300px;' >"; ?></td>
				<!-- action -->
